...
#         self.work_space_tool.ui.pushButton_13.clicked.connect(self.continue_to_calculate)
    ...
    def handleCalc(self):
        ...
        # print( cores, queue,maxiters, InputInterval, road)
        # if sys.platform=='win32':
        #     print('Windows后端不支持云平台作业提交！')
        #     return 7777
        # # caspath = '/home/export/base/nsccwuxi_amd/amd_app/online3/'+ road
        # caspath = os.path.join('/home/export/online3/', getpass.getuser(), road)
        # print(caspath)
        casname = self.casPath.split('/')[-1]
        # print(casname)
        # print(self.projectpath)
        # projectpath = self.projectpath

        # #不创建工程情况,自动以cas名称命名文件夹
        # if projectpath == None:
        #     projectname = casname.replace('.cas','')
        #     projectpath = os.path.join('/home/export/online3/', getpass.getuser(),'IcesimProject', projectname)
        #     projectpath = self.auto_save_file(projectpath)
        #     print(projectpath)
        #     print(os.getcwd())
        ...
        path=os.path.join('/home/export/online3/',getpass.getuser(),'IcesimProject', '.ICESIM')
        if not os.path.exists(path):
            os.makedirs(path)
        print("saveaccountinfo！")
        print(path)
        projectname = self.workdir.split('/')[-1]
        # print(projectname)

        #生成案例的json文件
        jsonfile = os.path.join(path,projectname+'.json')
        print(jsonfile)
        ...
        cmd ='/opt/skyformai/bin/csub  -o output.txt -I -A ICESIM -Jd ICESIM/' + projectname
        cmd += ' -n '+self.cores
        cmd += ' -q '+self.queue
        cmd += ' -cwd '+self.workdir
        cmd += (' /home/export/base/nsccwuxi_amd/amd_app/online3/wxy/SALOME-9.4.0-CO7-SRC/BINARIES-CO7/Python/bin/python3 '
        # cmd += (' /home/export/online3/amd_share/ParaView-5.8.0-MPI-Linux-Python3.7-64bit/bin/pvpython '
                +'/home/export/base/nsccwuxi_amd/amd_app/online3/wxy/SALOME-9.4.0-CO7-SRC/BINARIES-CO7/ASTERSTUDY/lib/python3.6/site-packages/asterstudy/gui/cas2foam1/generate.py '
...
#         import time
#         os.chdir('/home/leo/Documents/Salome-9.4/SALOME-9.4.0-UB18.04-SRC/BINARIES-UB18.04/ASTERSTUDY/lib/python3.6/site-packages/asterstudy/workingdirectory')
...
#         log_root = self.workingdirectory + '/log.pimpleFoam'
#         while True:
#             try:
#                 time.sleep(delay)
